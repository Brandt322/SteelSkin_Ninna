package com.steelskin.controlador;

import com.steelskin.config.Fecha;
import com.steelskin.modelo.Carrito;
import com.steelskin.modelo.Cliente;
import com.steelskin.modelo.ClienteDAO;
import com.steelskin.modelo.Compra;
import com.steelskin.modelo.ComprasDAO;
import com.steelskin.modelo.DetalleCompra;
import com.steelskin.modelo.Pago;
import com.steelskin.modelo.Producto;
import com.steelskin.modelo.ProductoDAO;
import java.io.File;
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if(!fileItem.isFormField()){
                            ...
                            File file=new File(projectPath+"carrito/"+fileItem.getName());
                            fileItem.write(file);
                            p.setImagen("http://localhost:9443/carrito/"+fileItem.getName());
                            System.out.println("Ruta de la imagen: " + p.getImagen());
                        }else{
